/**
 * Step: groups — List groups from DB.
 * Channels discover group names at runtime — this step only lists what's known.
 */
import fs from 'fs';
...
export async function run(args: string[]): Promise<void> {
  ...
  // No upfront sync needed — channels discover groups at runtime.
  emitStatus('SYNC_GROUPS', {
    BUILD: 'skipped',
    SYNC: 'skipped',
    GROUPS_IN_DB: 0,
    REASON: 'no_upfront_sync_needed',
    STATUS: 'success',
    LOG: 'logs/setup.log',
  });
}
